# Generated by Django 3.1 on 2021-03-15 15:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('athletes', models.CharField(max_length=500)),
                ('visibility', models.CharField(choices=[('PU', 'Public'), ('CO', 'Coach'), ('PR', 'Private'), ('LT', 'Limited')], default='CO', max_length=2)),
